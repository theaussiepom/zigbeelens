...
![Resolved high-severity synthetic Study availability incident showing affected scope, supporting evidence, the counter-evidence statement, interpretation, and explicit limitations](screenshots/incidents-page.png)
...
high-severity availability Incident keeps its Study scope, supporting evidence,
counter-evidence statement, interpretation, and limitations visible together.
It records a pattern worth investigating; it does not establish a root cause.
