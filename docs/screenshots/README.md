...
| S4 | `incidents-page.png` | Core resolved high-severity synthetic Study availability incident with affected scope, evidence, counter-evidence, interpretation, and limitations | `docs/troubleshooting.md`, under Incidents not appearing |
